        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 bg-gradient-card shadow-neon">
            <CardContent className="p-8 md:p-12">
              <p className="text-lg text-muted-foreground leading-relaxed text-center mb-6 animate-scale-in animate-delay-400">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-center mb-6 animate-fade-in-up animate-delay-600">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-center animate-zoom-in animate-delay-800">
